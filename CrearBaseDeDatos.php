...
<body>
    ...
    <h2>Crear una base de datos: Pruebas</h2>     
    <?php
        ...
        $data = new BaseDatos();
            ...
            {   
                if(isset($_POST['creacion']))                 
                    $data->crearBaseDeDatos(); 
            }

    ?>        
    <form  id="crearBase" action='#' method='post' name='Formulario'>
        <input type='submit' class='button' name='creacion' value='Crear'/>
    </form>
